...
options=("Ubuntu Hirsute Hippo 21.04 Cloud Image" "Ubuntu Groovy 20.10 Cloud Image" "Ubuntu Focal 20.04 Cloud Image" "Ubuntu Minimal Focal 20.04 Cloud Image" "CentOS 7 Cloud Image" "Debian 10 Cloud Image" "Debian 9 Cloud Image" "Ubuntu 18.04 Bionic Image" "CentOS 8 Cloud Image" "Rocky Linux 8 Cloud Image" "Fedora 32 Cloud Image" "Rancher OS Cloud Image")
...
do
  case $osopt in
        ...
        "Rocky Linux 8 Cloud Image")
          [ -f "$isostorage/Rocky-8-GenericCloud-8.5-20211114.2.x86_64.qcow2" ] && echo && echo "Moving on you have his cloud image" && break || echo && echo "You do not have this cloud image file so we are downloading it now" && echo && wget https://download.rockylinux.org/pub/rocky/8.5/images/Rocky-8-GenericCloud-8.5-20211114.2.x86_64.qcow2 -P $isostorage && break
          ;;          
